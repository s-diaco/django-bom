...
def update_sellerpart_fk(apps, schema_editor):
    ...
    for sp in SellerPart.objects.all():
        (mp, created) = ManufacturerPart.objects.get_or_create(
            part=sp.part,
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="manufacturer_part",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="bom.ManufacturerPart"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="sellerpart",
            unique_together={
                ("seller", "manufacturer_part", "minimum_order_quantity", "unit_cost")
            },
        ),
        migrations.AlterUniqueTogether(
            name="manufacturerpart",
