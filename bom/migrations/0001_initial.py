...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subscription",
                    models.CharField(
                        choices=[("F", "Free"), ("P", "Pro")], max_length=1
                    ),
                ),
                (
                    "owner",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "seller",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="bom.Seller"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.CharField(
                        choices=[("A", "Admin"), ("V", "Viewer")], max_length=1
                    ),
                ),
                (
                    "organization",
        ...
        migrations.AddField(
            ...
            name="organization",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="bom.Organization"
            ),
        ),
        migrations.AddField(
            model_name="part",
            ...
            field=models.ManyToManyField(
                blank=True, through="bom.Subpart", to="bom.Part"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name="part",
            unique_together={
                ("number_class", "number_item", "number_variation", "organization")
            },
        ),
    ]
